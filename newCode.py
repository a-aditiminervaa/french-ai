...
def phonetic_comparison(reference_text, user_transcription):
    try:
        ...
        # Compare phonemes of the user and the reference
...
def choose_word_method(french_words):
    print("Choose word method:")
    print("1. Use a random word from the list")
    ...
    if choice == '1':
        ...
        reference_text = input("Enter the word you want to practice: ").strip()
    else:
        print("Invalid choice. Please enter 1 or 2.")
        return choose_word_method(french_words)
...
def choose_input_method():
    ...
    print("2. Record audio in real-time")
    choice = input("Enter the number of your choice: ")
...
# Choose word method and get reference text
reference_text = choose_word_method(french_words)

# Inform and pronounce the word for the user
print(f"Please say the following word: {reference_text}")
speak_text(reference_text)

# Choose input method and handle audio
audio_path = choose_input_method()

# Transcribe and analyze
user_transcription = transcribe_audio(audio_path)
